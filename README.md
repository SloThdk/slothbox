...
[![Status: v0.2.13](https://img.shields.io/badge/status-v0.2.13-blue)](MILESTONES.md)
[![EU-hosted](https://img.shields.io/badge/region-EU--only-blue)](#why-eu-hosted)

> [!NOTE]
> **v0.2.13 — current release. Read this before sending real data.**
>
> The v0.2 line closed the two URL-leak risks the v0.1 warning block
> called out. As of v0.2.13 the shipped guarantees are:
>
...
> any "production-grade" or "high-stakes secrets" framing. v0.2.13 is
...
- **Role:** the durability + audit layer. The `audit_chain` table is
  ...
  **not yet enforced as of v0.2.13** — see "Trust model" below for the
  honest framing.
