// Select — Radix primitive composition styled for SlothBox.
//
// We expose the full primitive surface but pre-style each piece so callers
// only import named building blocks: `<Select>`, `<SelectTrigger>`, etc.
